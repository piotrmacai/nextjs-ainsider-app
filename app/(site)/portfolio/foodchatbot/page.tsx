          ...
          <div className="flex flex-col-reverse lg:flex-row gap-7.5 xl:gap-12.5">
            ...
            <div className="lg:w-2/3">
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                ...
                {t('mainPortfolio.footbot.header')}
                </h2> */}
                <div className="mb-10 w-full overflow-hidden">
                  <div className="relative aspect-[97/60] w-full sm:aspect-[97/78]">
                    <Image
                      src="/images/portfolio/foodchatbot.jpg"
                ...
                <div className="blog-details">
                  <h2 className="font-semibold text-3xl 2xl:text-sectiontitle2 text-black dark:text-white mb-5">
                  {t('mainPortfolio.footbot.header')}                  </h2>
                  <p>
                  {t('mainPortfolio.footbot.desc1')}
                  </p>
                  <p>
                  {t('mainPortfolio.footbot.desc2')}
                  </p>
                </div>
                <SharePost />
              </div>
