...
const SingleBlogPage = () => {
  ...
  return (
    <>
      <title>{`AI Voice Agents - Details`}</title>
        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
            ...
            <div className="md:w-1/2 lg:w-[32%]">
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-9 mb-10">
                <h4 className="font-semibold text-2xl mt-2 mb-7.5">
                  {t("voicebotsPage.detailsTitle")}
                </h4>

                <ul>
                  <li className="mb-3">
                    <p>{t("voicebotsPage.techStack")}:</p>
                    <p className="text-white">
                      Vapi, Twilio, Next.js, Python, n8n, LangChain, Vercel AI SDK
                    </p>
                  </li>
                  <li className="mb-3">
                    <p>{t("voicebotsPage.models")}:</p>
                    <p className="text-white">
                      GPT-4o, Claude 3.5 Sonnet, Gemini 1.5 Pro, Llama 3
                    </p>
                  </li>
                  <li className="mb-3">
                    <p>{t("voicebotsPage.apis")}:</p>
                    <p className="text-white">
                      OpenAI, Anthropic, Google Vertex AI
                    </p>
                  </li>
                  <li>
                    <p>{t("voicebotsPage.category")}:</p>
                    <p className="text-white">
              ...
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                ...
                <div className="blog-details">
                  <div className="flex flex-col gap-6 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg border">
                    <div>
                      <h4 className="font-bold text-lg mb-2">{t("voicebotsPage.problemTitle")}:</h4>
                      <p>{t("voicebotsPage.problemText")}</p>
                    </div>
                    <div>
                      <h4 className="font-bold text-lg mb-2">{t("voicebotsPage.solutionTitle")}:</h4>
                      <p>{t("voicebotsPage.solutionText")}</p>
                    </div>
                    <div>
                      <h4 className="font-bold text-lg mb-2">{t("voicebotsPage.effectTitle")}:</h4>
                      <p>{t("voicebotsPage.effectText")}</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="mt-20">
            <h2 className="text-2xl font-bold mb-10">
              {t("voicebotsPage.otherProjectsTitle")}
            </h2>
                  ...
                  <div className="flex flex-col flex-1 justify-center">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.tags?.map((tag, i) => (
                        <span key={i} className="px-3 py-1 text-xs rounded-full bg-primary/5 text-primary">
                          {tag}
                        </span>
                      ))}
                    </div>
