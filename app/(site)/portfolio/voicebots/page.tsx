              ...
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-9 mb-10">
                ...
                <ul>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>Tech Stack:</p>
                    <p className="text-white transition-all duration-300 hover:text-primary">Vapi, Twilio, Next.js, Python, n8n, LangChain, Vercel AI SDK</p>
                  </li>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>Models:</p>
                  ...
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>APIs:</p>
                    <p className="text-white transition-all duration-300 hover:text-primary">OpenAI, Anthropic, Google Vertex AI</p>
                  </li>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>Category:</p>
                ...
                <div className="blog-details">
                  <div className="flex flex-col gap-6 p-6 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700">
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">Missed calls & inquiries.</p>
                    </div>
                    <div>
                      <h4 className="font-bold text-lg text-black dark:text-white mb-2">Solution:</h4>
                      <p className="text-gray-600 dark:text-gray-300">Voice AI answering calls exactly like a human.</p>
                    </div>
                    <div>
                      <h4 className="font-bold text-lg text-black dark:text-white mb-2">Effect:</h4>
                      <p className="text-gray-600 dark:text-gray-300">100% call pickup rate & lead capture.</p>
                    </div>
                  </div>
                </div>
