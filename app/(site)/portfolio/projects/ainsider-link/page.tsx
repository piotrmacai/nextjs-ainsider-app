              ...
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-9 mb-10">
                ...
                <ul>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>Link:</p>
                    <a href="https://ainsider-co.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-white transition-all duration-300 hover:text-primary">ainsider-co.vercel.app</a>
                  </li>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                  ...
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    ...
                    <p className="text-white transition-all duration-300 hover:text-primary">Web Apps & AI</p>
                  </li>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>{t('mainPortfolio.tech')}</p>
                    <p className="text-white transition-all duration-300 hover:text-primary">Next.js</p>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                ...
                <div className="mb-10 w-full overflow-hidden">
                  <div className="relative aspect-[97/60] w-full sm:aspect-[97/66]">
                    <Image
                      src="/images/portfolio/ainsiderlink.jpg"
                      alt="Ainsider Link"
                      layout="fill"
                ...
                <div className="blog-details">
                    <p> {t('mainPortfolio.ainsiderlink.desc1')}</p>
                    <p>{t('mainPortfolio.ainsiderlink.desc2')}</p>
                </div>
                <SharePost />
              </div>
            </div>
