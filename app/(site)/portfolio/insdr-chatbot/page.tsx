              ...
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-9 mb-10">
                ...
                <ul>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>Link:</p>
                    <a href="https://github.com/piotrmacai/ai-chatbot-vercel-v1.0" target="_blank" rel="noopener noreferrer" className="text-white transition-all duration-300 hover:text-primary">See at Github</a>
                  </li>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                  ...
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    ...
                    <p className="text-white transition-all duration-300 hover:text-primary">AI Assistants & Agents</p>
                  </li>
                  <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>{t('mainPortfolio.tech')}</p>
                    <p className="text-white transition-all duration-300 hover:text-primary">Next.js + OpenAI API</p>
                  </li>
                  {/* <li className="last:mb-0 mb-3 transition-all duration-300">
                    <p>Cel:</p>
            ...
            <div className="lg:w-2/3">
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                ...
                <div className="blog-details">
                  <p>
                  {t('mainPortfolio.nextbot.desc1')}                  </p>
                  <p>
                  {t('mainPortfolio.nextbot.desc2')}                  </p>
                </div>
