          ...
          <div className="flex flex-col-reverse lg:flex-row gap-7.5 xl:gap-12.5">
              ...
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                ...
                <div className="blog-details">
                  ...
                  <p className="text-black dark:text-white">{t('leadbot.forwho')}</p> 
                   <p className="text-black dark:text-white">{t('leadbot.who1')} </p>
                   <p className="text-black dark:text-white"> {t('leadbot.who2')}</p>
                   <p className="text-black dark:text-white"> {t('leadbot.who3')}</p>
                   <p className="text-black dark:text-white"> {t('leadbot.who4')}</p>
