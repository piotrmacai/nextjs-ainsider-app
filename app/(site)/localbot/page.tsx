              ...
              <div className="animate_top rounded-md shadow-solid-13 bg-white dark:bg-blacksection border border-stroke dark:border-strokedark p-7.5 md:p-10">
                ...
                <div className="mb-10 w-full overflow-hidden ">
                  ...
                  <div className="relative aspect-[97/60] w-full sm:aspect-[97/78]">
                    <Image
                      src={"/images/portfolio/ollama.png"}
                      alt="Ai Tools Bot"
                      fill
                ...
                <div className="blog-details">
                  ...
                  <p className="text-black dark:text-white">{t('localbot.forwho')}</p> 
                   <p className="text-black dark:text-white">{t('localbot.who1')} </p>
                   <p className="text-black dark:text-white"> {t('localbot.who2')}</p>
                   <p className="text-black dark:text-white"> {t('localbot.who3')}</p>
                   <p className="text-black dark:text-white"> {t('localbot.who4')}</p>
