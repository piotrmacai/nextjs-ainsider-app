...
const ProductAgent: React.FC<UseCaseProps> = () => {
    ...
    const SECTIONS = [
        { id: "overview", label: t('customagents.navigation.overview') },
        { id: "features", label: t('customagents.navigation.features') },
        { id: "examples", label: t('customagents.navigation.examples') },
        { id: "integration", label: t('customagents.navigation.integration') },
        { id: "faq", label: t('customagents.navigation.faq') },
    ];
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                    ...
                    <aside className="hidden lg:block w-64 shrink-0">
                        <div className="sticky top-24 space-y-8">
                            <div className="p-6 rounded-2xl border border-black/5 dark:border-white/10 bg-white/50 dark:bg-black/20 backdrop-blur-md">
                                <h3 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4">{t('customagents.sidebar.onThisPage')}</h3>
                            ...
                            {/* <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-600 to-blue-600 text-white shadow-xl">
                                <h4 className="font-bold text-lg mb-2">{t('customagents.sidebar.tryForFree.title')}</h4>
                                <p className="text-white/80 text-sm mb-4">{t('customagents.sidebar.tryForFree.desc')}</p>
                                <Link href="/contact" className="block w-full py-2 px-4 bg-white text-purple-600 rounded-lg text-center text-sm font-bold hover:bg-gray-100 transition-colors">
                                    {t('customagents.sidebar.tryForFree.button')}
                                </Link>
                            </div> */}
                        </div>
                    </aside>
                    ...
                    <main className="flex-1 min-w-0">
                        ...
                        <div className="lg:hidden flex items-center justify-between mb-8 pb-4 border-b border-gray-200 dark:border-gray-800">
                            <span className="font-serif italic text-xl">{t('customagents.mobile.app')}</span>
                            <button
                        ...
                        <section id="overview" className="mb-20 pt-4 scroll-mt-24">
                            ...
                            >
                                ...
                                <div className="relative group perspective-1000 self-end">
                                    ...
                                    >
                                        <Image
                                            src="/images/portfolio/macaivoicebot.png"
                        ...
                        <section id="features" className="mb-20 scroll-mt-24">
                            <h2 className="text-3xl font-bold mb-8 flex items-center gap-3">
                                ...
                                {t('customagents.features.title')}
                            </h2>
                            <div className="grid md:grid-cols-2 gap-6">
                                {(t('customagents.features.list', { returnObjects: true }) as FeatureItem[]).map((feature, i) => (
                        ...
                        <section id="examples" className="mb-20 scroll-mt-24">
                            <h2 className="text-3xl font-bold mb-8 flex items-center gap-3">
                                {t('customagents.usecases.title')}
                            </h2>

                            <div className="grid gap-6">
                                {/* Example 1: Real Estate */}
                                {(() => {
                                    const useCase = t('customagents.usecases.realestate', { returnObjects: true }) as UseCaseItem;
                                    return (
                                ...
                                {/* Example 2: Interior */}
                                {(() => {
                                    const useCase = t('customagents.usecases.interior', { returnObjects: true }) as UseCaseItem;
                                    return (
                        ...
                        <section id="integration" className="mb-20 scroll-mt-24">
                            <div className="bg-gray-50 dark:bg-white/5 rounded-3xl p-8 md:p-12 border border-gray-100 dark:border-white/5 text-gray-900 dark:text-white">
                                <h2 className="text-3xl font-bold mb-6 flex items-center gap-3">
                                    <span className="w-8 h-8 rounded-lg bg-green-500 flex items-center justify-center text-white text-sm">03</span>
                                    {t('customagents.integration.title')}
                                </h2>
                                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl">
                                    {t('customagents.integration.desc')}
                                </p>

                                <div className="flex flex-wrap gap-4 mb-8">
                                    {(t('customagents.integration.tools', { returnObjects: true }) as string[]).map(tech => (
                                ...
                                <div className="relative rounded-xl overflow-hidden bg-[#fff] dark:bg-[#1e1e1e] p-4 font-mono text-sm text-gray-600 dark:text-gray-300 shadow-inner">
                                    ...
                                    <div className="space-y-2">
                                        <p className="text-gray-900 dark:text-white">{t('customagents.integration.code.step1')}</p>
                                        <p className="text-gray-900 dark:text-white">{t('customagents.integration.code.step2')}</p>
                                        <p className="text-gray-900 dark:text-white">{t('customagents.integration.code.step3')}</p>
                                        <p className="text-gray-900 dark:text-white">{t('customagents.integration.code.step4')}</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="faq" className="mb-20 scroll-mt-24">
                            <h2 className="text-3xl font-bold mb-8 flex items-center gap-3">
                                ...
                                {t('customagents.faq.title')}
                            </h2>
                            <div className="space-y-4">
                                {(t('customagents.faq.items', { returnObjects: true }) as FaqItem[]).map((faq, i) => (
...
//     const displayTitle = title || t('customagents.hero.title');
//     const displaySubtitle = subtitle || t('customagents.hero.subtitle');
...
//                                                 }`}
//                                         >
//                                             {t(`customagents.navigation.${section.id}`)}
//                                         </button>
//                                     ))}
//                                 </nav>
//                             </div>
...
//                                             {t('customagents.hero.placeholder')}
//                                         </span>
//                                     </div>
...
//                             </h2>
//                             <div className="grid md:grid-cols-2 gap-6">
//                                 {(t('customagents.features.list', { returnObjects: true }) as any[]).map((feature, i) => (
//                                     <div key={i} className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-gray-100 dark:border-white/5 hover:border-purple-500/50 transition-colors shadow-lg shadow-gray-200/50 dark:shadow-none">
//                                         <div className="w-12 h-12 rounded-full bg-purple-50 dark:bg-purple-900/20 flex items-center justify-center mb-4 text-purple-600 dark:text-purple-400">
//                                             <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={feature.icon} /></svg>
//                                         </div>
...
//                                                 <span className="font-bold text-lg">{t('customagents.usecases.realestate.tag')}</span>
//                                             </div>
//                                         </div>
//                                         <div className="flex-1">
//                                             <h3 className="text-2xl font-bold mb-3 flex items-center gap-2">
//                                                 {t('customagents.usecases.realestate.title')}
//                                                 <span className="px-2 py-1 rounded text-xs bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400">{t('customagents.usecases.realestate.badge')}</span>
//                                             </h3>
//                                             <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
//                                                 {t('customagents.usecases.realestate.desc')}
//                                             </p>
//                                             <ul className="space-y-2 mb-6">
//                                                 {(t('customagents.usecases.realestate.benefits', { returnObjects: true }) as string[]).map((benefit, i) => (
...
//                                                 <span className="font-bold text-lg">{t('customagents.usecases.interior.tag')}</span>
//                                             </div>
//                                         </div>
//                                         <div className="flex-1">
//                                             <h3 className="text-2xl font-bold mb-3 flex items-center gap-2">
//                                                 {t('customagents.usecases.interior.title')}
//                                                 <span className="px-2 py-1 rounded text-xs bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400">{t('customagents.usecases.interior.badge')}</span>
//                                             </h3>
//                                             <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
//                                                 {t('customagents.usecases.interior.desc')}
//                                             </p>
//                                             <ul className="space-y-2 mb-6">
//                                                 {(t('customagents.usecases.interior.benefits', { returnObjects: true }) as string[]).map((benefit, i) => (
//                                                     <li key={i} className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
...
//                                     </div>
//                                     <div className="space-y-2">
//                                         <p className="text-gray-500">{t('customagents.integration.code.step1')}</p>
//                                         <p className="text-pink-500">{t('customagents.integration.code.step2')}</p>
//                                         <p>{t('customagents.integration.code.step3')}</p>
//                                         <p className="text-green-400">{t('customagents.integration.code.step4')}</p>
//                                     </div>
//                                 </div>
//                             </div>
//                         </section>
...
//                             </h2>
//                             <div className="space-y-4">
//                                 {(t('customagents.faq.items', { returnObjects: true }) as any[]).map((faq, i) => (
//                                     <details key={i} className="group p-6 rounded-2xl bg-white dark:bg-white/5 border border-gray-100 dark:border-white/5 open:ring-1 open:ring-purple-500/20">
//                                         <summary className="font-bold text-lg cursor-pointer flex items-center justify-between list-none">
//                                             {faq.q}
//                                             <span className="transition-transform group-open:rotate-180">
...
//                         {/* CTA SECTION - ADDED TO MATCH ARCHI DESIGNER STRUCTURE */}
//                         <section className="mb-20">
//                             <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-500 p-8 md:p-12 text-center text-white shadow-2xl">
//                                 {/* Decorative elements */}
...
//                                     <h2 className="text-3xl text-gray-100 dark:text-gray-100 md:text-4xl font-bold mb-4">
//                                         {t('customagents.cta.title')}
//                                     </h2>
//                                     <p className="text-lg md:text-xl text-gray-100 dark:text-gray-200 mb-8 max-w-2xl mx-auto">
//                                         {t('customagents.cta.subtitle')}
//                                     </p>
//                                     <Link href="/contact" className="inline-block px-8 py-3 rounded-full font-bold bg-white text-purple-600 hover:bg-gray-100 transition-colors">
//                                         {t('customagents.cta.button')}
//                                     </Link>
//                                 </div>
//                             </div>
