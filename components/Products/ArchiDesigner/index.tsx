...
const ProductArchiDesigner: React.FC<UseCaseProps> = () => {
    ...
    const SECTIONS = [
        { id: "overview", label: t('archidesigner.navigation.overview') },
        { id: "features", label: t('archidesigner.navigation.features') },
        { id: "examples", label: t('archidesigner.navigation.examples') },
        { id: "integration", label: t('archidesigner.navigation.integration') },
        { id: "faq", label: t('archidesigner.navigation.faq') },
    ];
                    ...
                    <main className="flex-1 min-w-0">
                        ...
                        <section id="overview" className="mb-20 pt-4 scroll-mt-24">
                            ...
                            >
                                ...
                                <div className="relative group perspective-1000 self-end">
                                    ...
                                    >
                                        <Image
                                            src="/images/genai/archidesigner.jpg"
                        ...
                        <section id="features" className="mb-20 scroll-mt-24">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                {(t('archidesigner.features.list', { returnObjects: true }) as FeatureItem[]).map((feature, i) => (
                        ...
                        <section id="examples" className="mb-20 scroll-mt-24">
                            ...
                            <div className="grid gap-6">
                                ...
                                {(() => {
                                    const useCase = t('archidesigner.usecases.realestate', { returnObjects: true }) as UseCaseItem;
                                    return (
                                ...
                                {/* Example 2: Interior */}
                                {(() => {
                                    const useCase = t('archidesigner.usecases.interior', { returnObjects: true }) as UseCaseItem;
                                    return (
                            ...
                            <div className="bg-gray-50 dark:bg-white/5 rounded-3xl p-8 md:p-12 border border-gray-100 dark:border-white/5 text-gray-900 dark:text-white">
                                ...
                                <div className="relative rounded-xl overflow-hidden bg-[#fff] dark:bg-[#1e1e1e] p-4 font-mono text-sm text-gray-600 dark:text-gray-300 shadow-inner">
                                    ...
                                    <div className="space-y-2">
                                        <p className="text-gray-900 dark:text-white">{t('archidesigner.integration.code.step1')}</p>
                                        <p className="text-gray-900 dark:text-white">{t('archidesigner.integration.code.step2')}</p>
                                        <p className="text-gray-900 dark:text-white">{t('archidesigner.integration.code.step3')}</p>
                                        <p className="text-gray-900 dark:text-white">{t('archidesigner.integration.code.step4')}</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section id="faq" className="mb-20 scroll-mt-24">
                            ...
                            <div className="space-y-4">
                                {(t('archidesigner.faq.items', { returnObjects: true }) as FaqItem[]).map((faq, i) => (
