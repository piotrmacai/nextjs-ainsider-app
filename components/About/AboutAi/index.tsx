...
const AboutAi = () => {
  ...
  return (
    <>
      {/* <!-- ===== About Start ===== --> */}
      <section className="py-5 lg:py-10 xl:py-15 overflow-hidden">
          ...
          <motion.div
            ...
            >
              <h4 className="text-black dark:text-white font-medium uppercase">
                ...
                {t('heroAiSection.AboutAI.header1.header1')}
                </span>{" "}
                {t('heroAiSection.AboutAI.header1.header2')}
              </h4>
           ...
           {t('heroAiSection.AboutAI.header1.header4')}
                </span>
              </h2>
              <p>
              {t('heroAiSection.AboutAI.header1.desc1')}             
               </p>
               <div>
                <a
                  href="/contact"
                ...
                >
                  <span className="hover:pr-2 duration-500">{t('heroAiSection.AboutAI.header2.button')}</span>
                  <svg
                    width="14"
                    height="14"
                    viewBox="0 0 14 14"
      ...
      {/* <section>
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 2xl:px-0 overflow-hidden">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h4 className="text-black dark:text-white font-medium uppercase">
              {t('heroAiSection.AboutAI.header2.header1')}
              </h4>
              <h2 className="relative font-bold text-black dark:text-white text-3xl xl:text-hero mb-6">
              {t('heroAiSection.AboutAI.header2.header1')}    
              </h2>
              <p>
              {t('heroAiSection.AboutAI.header2.desc1')}                 </p>
              <div>
                <a
                  href="/contact"
                  className="flex items-center gap-2.5 text-black dark:text-white mt-7.5 hover:text-primary dark:hover:text-primary"
