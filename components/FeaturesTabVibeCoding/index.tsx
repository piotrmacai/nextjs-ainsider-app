          ...
          >
            ...
            >
              ...
              <div className="lg:w-auto md:w-3/5">
                ...
                {t('heroWebSection.WebFeaturesTab.header.tabOne')}
                </h5>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="lg:w-auto md:w-3/5">
                <h5 className="text-black dark:text-white text-sm xl:text-regular font-medium">
                {t('heroWebSection.WebFeaturesTab.header.tabTwo')}
                </h5>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div className="lg:w-auto md:w-3/5">
                <h5 className="text-black dark:text-white text-sm xl:text-regular font-medium">
                {t('heroWebSection.WebFeaturesTab.header.tabThree')}
                </h5>
              </div>
            </div>
          </motion.div>
...
export default VibeCodingFeaturesTab;
