...
const featuresTabData: FeatureTab[] = [
  {
    id: "tabOne",
    title: t('VibeCodingFeaturesTab.tab1Title'),
    desc1: t('VibeCodingFeaturesTab.tab1Description1'),
    desc2: t('VibeCodingFeaturesTab.tab1Description2'),
    image: "/images/features/undraw_wireframing.svg",
    imageDark: "/images/features/undraw_wireframing.svg",
  },
  {
    id: "tabTwo",
    title: t('VibeCodingFeaturesTab.tab2Title'),
    desc1: t('VibeCodingFeaturesTab.tab2Description1'),
    desc2: t('VibeCodingFeaturesTab.tab2Description2'),
    image: "/images/features/undraw_online_stats.svg",
    imageDark: "/images/features/undraw_online_stats.svg",
  },
  {
    id: "tabThree",
    title: t('VibeCodingFeaturesTab.tab3Title'),
    desc1: t('VibeCodingFeaturesTab.tab3Description1'),
    desc2: t('VibeCodingFeaturesTab.tab3Description2'),
