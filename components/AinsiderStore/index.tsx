...
const AinsiderStore = () => {
    ...
    const links = [
        ...
        },
        {
            ...
            url: "https://ainsider.ai.substack.com",
                ...
                <div className="bg-transparent relative z-10 flex flex-col md:flex-row items-stretch">
                    ...
                    <div className="w-full md:w-2/5 p-8 md:p-12 flex flex-col justify-between border-b md:border-b-0 md:border-r border-gray-100/80 dark:border-white/5 bg-white/40 dark:bg-white/[0.02]">
                        <div>
                            ...
                            {/* UPDATED: Description text forced to white in dark mode */}
                        ...
                        <div className="mt-auto">
                            {/* UPDATED: Label forced to white in dark mode */}
                            <p className="text-xs font-semibold text-gray-400 dark:text-white uppercase tracking-widest mb-4">Connect with us</p>
                            <div className="flex gap-4">
                                {/* UPDATED: Icons forced to white in dark mode */}
                                <a href="#" className="p-2 rounded-full bg-white/80 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-300 hover:border-indigo-200 dark:hover:border-indigo-500/30 hover:bg-indigo-50 dark:hover:bg-white/10 transition-all duration-300">
                                    <Twitter className="w-5 h-5" />
                                </a>
                                <a href="#" className="p-2 rounded-full bg-white/80 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-white hover:text-blue-700 dark:hover:text-blue-300 hover:border-blue-200 dark:hover:border-blue-500/30 hover:bg-blue-50 dark:hover:bg-white/10 transition-all duration-300">
                                    <Linkedin className="w-5 h-5" />
                                </a>
                                <a href="#" className="p-2 rounded-full bg-white/80 dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-600 dark:text-white hover:text-black dark:hover:text-gray-200 hover:border-gray-400 dark:hover:border-white/30 hover:bg-gray-100 dark:hover:bg-white/10 transition-all duration-300">
                            ...
                            {links.map((link, index) => (
                                ...
                                >
                                    ...
                                    <div className="relative z-10 flex justify-between items-start mb-4">
                                        ...
                                        {/* Action Arrow - UPDATED: Forced to white in dark mode */}
                                    ...
                                    <div className="relative z-10">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            {link.tag && (
                                                /* UPDATED: Tag text forced to white in dark mode */
