...
//   return (
//     <>
//       <section className="pt-20 md:pt-26 xl:pt-28 pb-4 xl:pb-6 px-3 overflow-hidden">
//         <div className="mx-auto max-w-c-1390 px-4 md:px-4 2xl:px-0 flex flex-col md:flex-row"> {/* Added flex and flex-col for mobile view */}
//           <div className="md:w-1/2 sm:w-full md:block mb-8 md:mb-0 md:mt-8"> {/* Added mb-8 for mobile view */}
...
//                   <Image src="/images/brand/github.png" alt="git" width={24} height={24} className="fill-[#7B7A84] hover:fill-primary transition-all duration-300"/>
//                   </a>
//                 </li>
//     <li>
...
//               <div className="md:w-1/2 display-flex flex-1 relative w-full h-full mt-26 md:mt-20 sm:mt-20 mt:-[26] ">
//                 <div className="w-full relative scale-140">
//                   <SplineScene
