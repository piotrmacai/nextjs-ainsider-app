  ...
  const featuresData: Feature[] = [ 
    {
      ...
      title: t('aivoiceagentsFeatures.1Title'),
      description: t('aivoiceagentsFeatures.2Description'),
     }, 
    {
      id: 2,
      icon: "/images/icon/undraw_innovative.svg",
      title: t('aivoiceagentsFeatures.2Title'),
      description: t('aivoiceagentsFeatures.2Description'),
    },   
    {
      id: 3,
      icon: "/images/icon/undraw_ecom.svg",
      title: t('aivoiceagentsFeatures.3Title'),
      description: t('aivoiceagentsFeatures.3Description'),
    },   
    {
      id: 4,
      icon: "/images/icon/undraw_social.svg",
      title: t('aivoiceagentsFeatures.4Title'),
      description: t('aivoiceagentsFeatures.4Description'),
    }, 
    {
      id: 5,
      icon: "/images/icon/undraw_active.svg",
      title: t('aivoiceagentsFeatures.5Title'),
      description: t('aivoiceagentsFeatures.5Description'),
     },   
       
     {
      id: 6,
      icon: "/images/icon/undraw_product_iteration.svg",
      title: t('aivoiceagentsFeatures.6Title'),
      description: t('aivoiceagentsFeatures.6Description'),
    }, 
